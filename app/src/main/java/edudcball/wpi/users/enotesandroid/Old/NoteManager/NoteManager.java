...
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.ConnectionTestTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.noteTasks.DeleteTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.noteTasks.NewNoteTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.RetrieveNotesTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.noteTasks.UpdateNoteTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.pageTasks.DeletePageTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.pageTasks.NewPageTask;
import edudcball.wpi.users.enotesandroid.Old.AsyncTasks.pageTasks.UpdatePageTask;
import edudcball.wpi.users.enotesandroid.EventHandler;
import edudcball.wpi.users.enotesandroid.Settings;
import edudcball.wpi.users.enotesandroid.Old.activities.LoginActivity;
import edudcball.wpi.users.enotesandroid.Old.activities.MainActivity;
import edudcball.wpi.users.enotesandroid.Old.activities.NoteActivity;
import edudcball.wpi.users.enotesandroid.Old.activities.NotePageActivity;
...
public class NoteManager {
    ...
    private boolean load(Activity activity, String res){
        UserManager.getInstance().loadUserData(res);
